...
function M.setup(programs)
    ...
    hl.define_submap("global", function()
        ...
        hl.bind(main_mod .. " + SHIFT + S", exec("~/dotfiles/dot-config/programs/shell_scripts/screenshot-focused-monitor.sh"))
        ...
        hl.bind(main_mod .. " + SHIFT + T", exec("~/dotfiles/dot-config/programs/shell_scripts/tesseract-screenshot.sh eng"))
